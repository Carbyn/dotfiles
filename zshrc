...
alias jt="awk 'FNR==1 && NR!=1{next} {print}' ~/workspace/jarvis/data/trade_20*.csv > ~/workspace/jarvis/data/trade_all.csv; python3 ~/workspace/jarvis/scripts/colorcsv/colorcsv.py ~/workspace/jarvis/data/trade_all.csv; python3 ~/workspace/jarvis/scripts/stat_trade.py ~/workspace/jarvis/data/trade_all.csv"

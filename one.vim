...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  call <sid>X('Constant',       s:hue_6,         '',          '')
  call <sid>X('String',         s:hue_4,         '',          '')
  call <sid>X('Character',      s:hue_4,         '',          '')
  call <sid>X('Number',         s:hue_2,         '',          '')
  call <sid>X('Boolean',        s:hue_2,         '',          '')
  call <sid>X('Float',          s:hue_2,         '',          '')
  call <sid>X('Identifier',     s:hue_5,         '',          'none')
  call <sid>X('Function',       s:hue_3,         '',          '')
  call <sid>X('Statement',      s:hue_2,         '',          'none')
  call <sid>X('Conditional',    s:hue_2,         '',          '')
  call <sid>X('Repeat',         s:hue_2,         '',          '')
  call <sid>X('Label',          s:hue_2,         '',          '')
  call <sid>X('Operator',       s:syntax_accent, '',          'none')
  call <sid>X('Keyword',        s:hue_2,         '',          '')
  call <sid>X('Exception',      s:hue_2,         '',          '')
  call <sid>X('PreProc',        s:hue_6_2,       '',          '')
  call <sid>X('Include',        s:hue_2,         '',          '')
  call <sid>X('Define',         s:hue_2,         '',          'none')
